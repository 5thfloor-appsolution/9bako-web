				    	...
				    	<div id="login-section">
				    		<ul>
				    			<li class="account-login">
					    			<a href="<?php echo esc_url( get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ) ); ?>"><?php echo is_user_logged_in() ? __( 'Login / Register', 'easy-commerce' ) : __( 'Login / Register', 'easy-commerce' ) ; ?></a>
					    			</li>
			    			</ul>
			    		</div> <!-- .cart-section -->
			    	<?php endif; ?>
